<div>
    <h2 class="text-2xl font-bold text-gray-900">{{ __('auth.create_account') }}</h2>
    <p class="mt-2 text-sm text-gray-600">{{ __('auth.register_subtitle') }}</p>

    <div class="mt-6">
        <a href="{{ route('auth.google.redirect') }}" class="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition">
    ...
    <div class="relative mt-6">
        ...
        <div class="relative flex justify-center text-sm"><span class="bg-white px-4 text-gray-500">{{ __('auth.or') }}</span></div>
    </div>
