<div>
    <h2 class="text-2xl font-bold text-gray-900">{{ __('auth.login') }}</h2>
    ...
    <div class="mt-6 border-t pt-6">
        <form action="{{ route('auth.magic-link.send') }}" method="POST" class="flex gap-2">
            ...
            <input name="email" type="email" placeholder="{{ __('auth.magic_link_placeholder') }}"
                   class="flex-1 rounded-lg border-gray-300 text-sm shadow-sm focus:border-primary-500 focus:ring-primary-500">
